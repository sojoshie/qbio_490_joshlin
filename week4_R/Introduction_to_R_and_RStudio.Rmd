...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/home1/jlin7423/490_cluster")) 
```
...
age <- 18
birthday <- '07/17/2006'
three_fav_colors <- c('green', 'blue', 'beige')
...
if (1 > 2) {
  ...
  # action
  print('This will not run either!')
}
```
