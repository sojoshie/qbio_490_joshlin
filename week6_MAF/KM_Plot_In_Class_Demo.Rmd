...
```{r}
clean_clinical$age_category <- ifelse(clinical$age_at_diagnosis < 40, 'Young', ifelse(clinical$age_at_diagnosis < 65, 'Middle', 'Old'))
...
clean_clinical$survival_time <- ifelse(clinical$death_days_to == '[Not Applicable]', clinical$last_contact_days_to, clinical$death_days_to)
